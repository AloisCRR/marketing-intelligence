...
- Image `pgvector/pgvector:0.8.6-pg18-trixie`, `pgdata:/var/lib/postgresql`, `marketing-intelligence-db` healthy; `compose down/up` preserves rows (3 docs before/after); only named volume `marketing-intelligence_pgdata` attached.
